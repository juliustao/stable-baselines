...
def test(env_name, model_name):
    env = make_env(env_name)
    #video_path = f"../videos/{model_name}"
    ...
    # img.save("push_fixed_initial.png")
    ...
    while num_episodes < 100:
        ...
        if done or info.get('is_success', False):
            ...
            episode_reward = 0.0
            obs = env.reset()
    episode_success_rate = num_success_episodes / num_episodes
    print(f"Episode success rate: {episode_success_rate}")
    #imageio.mimsave(os.path.abspath(save_path))
